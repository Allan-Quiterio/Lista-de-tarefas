...
public class TarefaDAO implements ITarefaDAO{
    ...
    public boolean atualizar(Tarefa tarefa) {
        ...
        try {
            ...
            escreve.update(DbHelper.TABELA_TAREFAS,cv,"id=?",args);// ? é um caractere coringa pois não pode afirmar
            Log.e("INFO","Sucesso ao atualizar tarefa!");         // o que será editado pelo usuário
        }catch (Exception e){
    ...
    public List<Tarefa> listar() {
        ...
        //Retornando tarefas do Banco de Dados
